...
with(sir_values_1, {
  plot(x=time/24, y=B_cells, col="black", type="l", ylim= c(0,50),  xlab="Time (Hours)", ylab="Population density", main="Marek's Model", cex.lab = 1.5)          #Plot the data for S over time
