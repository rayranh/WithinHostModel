#v04- Changed to lognormal distribution, Getting rid of Recruitment, make beta & beta_2 the same 
...
n_per_alpha <- 50  # change this to 10, 50, 100, etc.
...
out_file <- file.path(
  ...
  paste0("SimplifyingModel_v04_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".csv")
)
