...
pp38_dat <- read_xlsx("/Users/rayanhg/Desktop/WithinHostModel/D", sheet = 3, na = "NA") %>% filter(!is.na(mean.pp38)) %>% select(time, Bcell_no,Tcell_no)
baigent2016 <- read_xlsx("/WithinHostModel/DataForProject/Baigent2016/Unvax/feathers_noVax_Fin_2.xlsx", 2 ) %>% arrange(time)
